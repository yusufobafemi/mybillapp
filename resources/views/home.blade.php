...
@section('content')
    <main class="dashboard-container">
        ...
        <div class="dashboard-grid">
            <!-- Balance Card -->
            <x-balance-card title="Account Balance" icon="fas fa-wallet" amount="₦125,430.00"
                change-text="+₦15,000 this week" change-type="positive" add-button-text="Add Money"
                transfer-button-text="Transfer" />
